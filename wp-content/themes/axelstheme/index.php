...
<html <?php language_attributes(); ?> ⚡>
  <head>
	...
	<meta name="author" content="Axel Segebrecht">
  ...
  <body>
	...
	<div class="py2">
		<div class="measure p2 txt--center">
			<h1 id="post-<?php the_ID(); ?>" class="h2">
				<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">
					<?php the_title(); ?><br />
				</a>
				<small class="small muted"><?php the_excerpt(); ?></small>
			</h1>
	        <div class="my2">
				<a href="#navbar-collapse" class="navbar-toggle collapsed btn" title="View navigation menu"><amp-img class="burger" src="<?php echo get_stylesheet_directory_uri(); ?>/burger.svg" width="16" height="16"></amp-img> Menu</a>
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Contact</a></li>
				...
				<a href="#article" class="btn" title="Jump to read the article"><strong>Read article &#8594;</strong></a>
	        </div>
		</div>
	</div>
	
	<div class="py2 bg--off-white">
		<div class="measure p2 entry" id="article">
	
			<?php the_content('Read the rest of this entry &raquo;'); ?>
		 
			<p class="postmetadata small">
				<?php edit_post_link('Edit','','<strong> &#8226; </strong>'); ?>
				Posted on <?php the_time('F jS, Y') ?> and filed under <?php the_category(', ') ?>
			</p>
			<p class="postmetadata">
				<?php comments_popup_link('Send your comments »', 'View comment »', 'View % comments »'); ?>
			</p>
			...
			<h2 class="txt--center">Nothing found</h2>
				<p class="txt--center">
					...
					<a href="#!" class="w100--s my1 btn--red" title="Furtive button example">&#8592; Return home</a><br />
					<amp-img src="<?php echo get_stylesheet_directory_uri(); ?>/404.jpg" width="300" height="300"></amp-img>
				</p>
