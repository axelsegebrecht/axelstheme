  ...
  <body>
	...
	<div class="py2">
		<div class="txt--center">
	        ...
	        <div class="my2">
	          <a href="#" class="btn" title="View navigation menu"><amp-img class="burger" src="<?php echo get_stylesheet_directory_uri(); ?>/burger.svg" width="16" height="16"></amp-img> Menu</a>
			  <a href="#" class="btn" title="Jump to read the article"><strong>Read article &#8594;</strong></a>
	        </div>
		</div>
	</div>
	
	<div class="py2 bg--off-white">
		<div class="measure p2 entry">
